"use client"
import { Leaf, Smartphone, Truck, ChevronLeft, ChevronRight, ArrowRight } from 'lucide-react'
...
const HeroSection = () => {
    const slides = [
        {
            id:1,
            icon:<Leaf className='w-20 h-20 sm:w-24 text-green-400 drop-shadow-lg'/>,
        ...
        {
            id:2,
            icon:<Truck className='w-20 h-20 sm:w-24 text-green-400 drop-shadow-lg'/>,
            title:"Fast Delivery",
        ...
        {
            id:3,
            icon:<Smartphone className='w-20 h-20 sm:w-24 text-green-400 drop-shadow-lg'/>,
            title:"Easy Shopping",
    ...
    return (
        <div className="w-[95%] max-w-7xl mx-auto mt-28 relative h-[450px] md:h-[550px] overflow-hidden rounded-3xl shadow-2xl group bg-slate-950">
            {/* Slide Container */}
            <AnimatePresence>
                <motion.div
                    key={current}
