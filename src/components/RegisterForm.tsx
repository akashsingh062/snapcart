    ...
    <div className="min-h-screen flex flex-col justify-center p-6 bg-white font-sans text-slate-800 relative">
      ...
      <div className="w-full max-w-md mx-auto space-y-6">
        <div className="text-center">
          ...
          <p className="text-slate-500 text-sm font-medium mt-2 flex items-center justify-center gap-1">
            Join Snapcart today <Leaf className="w-4 h-4 text-green-600" />
          </p>
        </div>

        {error && (
          <div className="p-4 rounded-2xl bg-red-50 border border-red-200 text-red-600 text-sm text-center animate-pulse">
            {error}
          </div>
        )}

        {success && (
          <div className="p-4 rounded-2xl bg-green-50 border border-green-200 text-green-700 text-sm text-center">
        ...
        >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-12 pr-12 py-3.5 bg-white border border-slate-200 rounded-2xl text-slate-800 placeholder-slate-400 focus:outline-none focus:border-green-600 transition-all text-base"
            />
            <button
              type="button"
          ...
          {(() => {
            ...
            return (
              <button
                ...
                className={`w-full py-3.5 px-4 rounded-2xl font-semibold transition-all duration-200 mt-2 text-center text-base shadow-sm border border-transparent flex items-center justify-center ${
        ...
        <div className="space-y-3">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-3.5 px-4 rounded-2xl bg-white hover:bg-slate-50 border border-slate-200 active:scale-[0.99] transition-all duration-200 text-base font-semibold text-slate-700 cursor-pointer shadow-sm"
          >
            <svg
              className="h-5 w-5"
              viewBox="0 0 24 24"
        ...
        <div className="text-center mt-6">
          <p className="text-sm text-slate-500">
            ...
            >
              <svg
                className="w-4 h-4 inline-block align-middle mr-0.5 text-green-600"
                fill="none"
                stroke="currentColor"
                strokeWidth="2.5"
                viewBox="0 0 24 24"
